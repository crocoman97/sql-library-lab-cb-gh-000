...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, SUM(*) AS books_sum FROM character_books JOIN characters ON characters.id = character_books.character_id GROUP BY ORDER BY books_sum DESC;"
end
